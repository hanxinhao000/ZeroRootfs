...
/**
 * A {@link Class} that defines the info needed by {@link com.termux.shared.termux.extrakeys.ExtraKeysView} to display the extra key
 * views.
 *
 ...
 * {@link com.termux.shared.termux.extrakeys.ExtraKeysConstants#CONTROL_CHARS_ALIASES}.
 * <p>
 * Its up to the {@link com.termux.shared.termux.extrakeys.ExtraKeysView.IExtraKeysView} client on how to handle individual key values
 * of an {@link com.termux.shared.termux.extrakeys.ExtraKeyButton}. They are sent as is via
 * {@link com.termux.shared.termux.extrakeys.ExtraKeysView.IExtraKeysView#onExtraKeyButtonClick(View, com.termux.shared.termux.extrakeys.ExtraKeyButton, Button)}. The
 * {@link com.termux.x11.utils.TermuxX11ExtraKeys} which is an implementation of the interface,
 * checks if the key is one of {@link com.termux.shared.termux.extrakeys.ExtraKeysConstants#PRIMARY_KEY_CODES_FOR_STRINGS} and generates
...
public class ExtraKeysInfo {
     ...
     */
    private final com.termux.shared.termux.extrakeys.ExtraKeyButton[][] mButtons;
     ...
     *              {@link com.termux.shared.termux.extrakeys.ExtraKeysConstants.ExtraKeyDisplayMap} that defines the display text
     *              mapping for the keys if a custom value is not defined by
     *              {@link com.termux.shared.termux.extrakeys.ExtraKeyButton#KEY_DISPLAY_NAME} for a key.
     * @param extraKeyAliasMap The {@link com.termux.shared.termux.extrakeys.ExtraKeysConstants.ExtraKeyDisplayMap} that defines the
     *                           aliases for the actual key names. You can create your own or
     *                           optionally pass {@link com.termux.shared.termux.extrakeys.ExtraKeysConstants#CONTROL_CHARS_ALIASES}.
     */
    public ExtraKeysInfo(@NonNull String propertiesInfo, String style,
                         @NonNull com.termux.shared.termux.extrakeys.ExtraKeysConstants.ExtraKeyDisplayMap extraKeyAliasMap) throws JSONException {
     ...
     * @param propertiesInfo The {@link String} containing the info to create the {@link ExtraKeysInfo}.
     *                       Check the class javadoc for details.
     * @param extraKeyDisplayMap The {@link com.termux.shared.termux.extrakeys.ExtraKeysConstants.ExtraKeyDisplayMap} that defines the
     *                           display text mapping for the keys if a custom value is not defined
     *                           by {@link com.termux.shared.termux.extrakeys.ExtraKeyButton#KEY_DISPLAY_NAME} for a key. You can create
    ...
    public ExtraKeysInfo(@NonNull String propertiesInfo,
                         @NonNull com.termux.shared.termux.extrakeys.ExtraKeysConstants.ExtraKeyDisplayMap extraKeyDisplayMap,
                         @NonNull com.termux.shared.termux.extrakeys.ExtraKeysConstants.ExtraKeyDisplayMap extraKeyAliasMap) throws JSONException {
        mButtons = initExtraKeysInfo(propertiesInfo, extraKeyDisplayMap, extraKeyAliasMap);
    }

    private com.termux.shared.termux.extrakeys.ExtraKeyButton[][] initExtraKeysInfo(@NonNull String propertiesInfo,
                                                                                    @NonNull com.termux.shared.termux.extrakeys.ExtraKeysConstants.ExtraKeyDisplayMap extraKeyDisplayMap,
                                                                                    @NonNull com.termux.shared.termux.extrakeys.ExtraKeysConstants.ExtraKeyDisplayMap extraKeyAliasMap) throws JSONException {
        ...
        com.termux.shared.termux.extrakeys.ExtraKeyButton[][] buttons = new com.termux.shared.termux.extrakeys.ExtraKeyButton[matrix.length][];
        for (int i = 0; i < matrix.length; i++) {
            buttons[i] = new com.termux.shared.termux.extrakeys.ExtraKeyButton[matrix[i].length];
            for (int j = 0; j < matrix[i].length; j++) {
                Object key = matrix[i][j];

                JSONObject jobject = normalizeKeyConfig(key);

                com.termux.shared.termux.extrakeys.ExtraKeyButton button;

                if (!jobject.has(com.termux.shared.termux.extrakeys.ExtraKeyButton.KEY_POPUP)) {
                    // no popup
                    button = new com.termux.shared.termux.extrakeys.ExtraKeyButton(jobject, extraKeyDisplayMap, extraKeyAliasMap);
                } else {
                    // a popup
                    JSONObject popupJobject = normalizeKeyConfig(jobject.get(com.termux.shared.termux.extrakeys.ExtraKeyButton.KEY_POPUP));
                    com.termux.shared.termux.extrakeys.ExtraKeyButton popup = new com.termux.shared.termux.extrakeys.ExtraKeyButton(popupJobject, extraKeyDisplayMap, extraKeyAliasMap);
                    button = new com.termux.shared.termux.extrakeys.ExtraKeyButton(jobject, popup, extraKeyDisplayMap, extraKeyAliasMap);
                }
     ...
     * {@link com.termux.shared.termux.extrakeys.ExtraKeyButton#ExtraKeyButton(JSONObject, com.termux.shared.termux.extrakeys.ExtraKeyButton, com.termux.shared.termux.extrakeys.ExtraKeysConstants.ExtraKeyDisplayMap, com.termux.shared.termux.extrakeys.ExtraKeysConstants.ExtraKeyDisplayMap)}.
     */
    private static JSONObject normalizeKeyConfig(Object key) throws JSONException {
        JSONObject jobject;
        if (key instanceof String) {
            jobject = new JSONObject();
            jobject.put(com.termux.shared.termux.extrakeys.ExtraKeyButton.KEY_KEY_NAME, key);
    ...
    @NonNull
    public static com.termux.shared.termux.extrakeys.ExtraKeysConstants.ExtraKeyDisplayMap getCharDisplayMapForStyle(String style) {
        switch (style) {
            case "arrows-only":
